...
Бизнес-аналитик с опытом автоматизации внутренних процессов, который умеет
довести решение до **рабочего продукта**, а не только до диаграммы.

- 🎯 Ищу позицию **бизнес-аналитика / специалиста по автоматизации процессов** —
  и параллельно беру заказы на Telegram-ботов и лендинги как разработчик
- 🧾 Опыт в техподдержке: работал в **Jira Service Desk**, настраивал процессы
  обработки заявок и вёл базу знаний
- 🤖 Перевожу ручные процессы в код: анализ требований → модель данных →
  готовый интерфейс. Использую **Claude, Gemini** как ускоритель разработки
- ⚙️ Мои pet-проекты — это решённые процессные задачи бизнеса: заявки со
  статусами и жизненным циклом, мини-CRM для лидов, автогенерация сайтов
- 📈 Сейчас в фокусе: углубляю **Django** и системный анализ
...
Каждый проект ниже — это не просто код, а решённая процессная задача:
описал требования, спроектировал жизненный цикл и довёл до рабочего продукта.
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:1F883D,100:1F6FEB&height=80&section=footer" width="100%" />
